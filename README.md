...
2. // สร้าง field โดยใช้ Array 2d / โดยจุดสตาร์ทต้องอยู่ที่ตำแหน่ง 0,0 
...
3. // check ตำแหน่งใหม่ตาม direction และตรวจสอบว่าอยู่ในกรอบหรือไม่
  ...
  // เขียนคำสั่ง Move แต่ล่ะทิศทาง ซ้าย ขวา บน ล่าง โดยมีการ check ว่าออกนอก Field ไหม และเตือนหรือ Game over
